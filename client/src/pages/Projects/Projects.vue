                ...
                <div class="grid gap-y-12">
                    <div v-for="(project, idx) of projects" :key="project.logoUrl" class="relative cursor-pointer">
                        <div class="block bg-white text-black p-8 pb-16 rounded-3xl relative z-10" @click="navigate(idx)">
                            <img src="../../assets/images/iHub_logo2.svg" class="mb-4" :class="[ project?.subdivision === 'Mycent' ? 'h-10' : 'h-16' ]" alt="project logo" />
                            <div class="flex items-center justify-between mb-2">
                                <p class="text-base leading-6 w-[585px]">{{  project.description  }}</p>
                                <div class="flex flex-col ml-12">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <p v-for="employee of project.Users">{{ employee.name }}</p>
                                        <p>+12</p>
                                    </div>
                                </div>
                            </div>
                            <p class="text-xl font-normal">Подразделение</p>
                            <h3 class="text-4xl font-medium">{{ project.name }}</h3>
